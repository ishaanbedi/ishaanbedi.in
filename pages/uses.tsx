        ...
        <>
            ...
            <div className={styles.container} >
                ...
                <section className='mt-7 lg:pl-3 max-w-4xl m-auto w-full'>
                    ...
                    <p className='my-4'>Check out this <a target={'_blank'} className=' font-bold link text-primary link-hover underline-offset-4 hover:underline text-bold' href='https://uses.tech/'>site</a> for a comprehensive list of /uses pages.</p>
                    <div className="editors-div my-8">
                        ...
                        <ul className='list-disc mt-4 ml-2'>
                            <li className='font-bold link text-primary link-hover underline-offset-4 hover:underline text-bold'><a href='https://code.visualstudio.com/insiders/' target={'_blank'}>Visual Studio Code - Insiders Edition</a></li>
                            <li className='ml-8'><a className='font-bold link text-primary link-hover underline-offset-4 hover:underline text-bold' href='https://marketplace.visualstudio.com/items?itemName=sdras.night-owl' target='_blank'>Night Owl</a> theme with <a className='font-bold link text-primary link-hover underline-offset-4 hover:underline text-bold' href='https://philpl.gumroad.com/l/dank-mono' target='_blank'>Dank Mono </a> &amp; <a className='font-bold link text-primary link-hover underline-offset-4 hover:underline text-bold' href='https://marketplace.visualstudio.com/items?itemName=PKief.material-icon-theme' target='_blank'>Material Icons.</a></li>
                            ...
                            <li><a className='font-bold link text-primary link-hover underline-offset-4 hover:underline text-bold' href='https://apps.apple.com/us/app/xcode/id497799835?mt=12' target='_blank'>Xcode</a> to build iOS applications.</li>
                        </ul>
                    </div>
